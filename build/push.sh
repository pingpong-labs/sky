...
git subtree push --prefix=src/Pingpong/Validator git@github.com:pingpong-labs/validator.git 2.0 --squash
git subtree push --prefix=src/Pingpong/Oembed git@github.com:pingpong-labs/oembed.git 2.0 --squash
